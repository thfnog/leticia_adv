...
var adm = $.tab({
	c:{a:'team',mt:'este Membro',ma:'Novo Membro',add:'admin/team/',fn:function(){
	...
	debugBuscaXML:0,
	o:'o,dc desc',
	oi:['id','o','tp','tipo','dc','da','s','nome','d','i','it','q'],
	th:[
		{t:2,n:'Imagem',w:104,tt:'n',a:'upload/team/',c:'i',d:'default.jpg',l:2,dl:1},
		{n:'Nome',w:250,o:'nome',tt:'nome',l:1,a:'admin/team/',c:'id',tb:0},
		{n:'Cadastrado em',w:130,o:'dc',tt:'_dc'},
		//{n:'Alterado em',w:130,o:'da',tt:'_da'},
		//{t:1,n:'Recortar Imagens',w:115,o:'it',bt:[{tt:1,m:'cp',a:'admin/crop-team/',i:['icrop','icropped'],t:['Recortar Imagens','Imagens Recortadas']}]},
		{t:1,n:'Adicionar Fotos',w:250,o:'t',bt:[{tt:1,m:'cp',a:'admin/team-foto/',i:'ifolder',t:'Adicionar Fotos'}]},
