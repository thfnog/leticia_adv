...
.ui-sortable tr:nth-child(8n+1),.ui-sortable tr:nth-child(8n+2),.ui-sortable tr:nth-child(8n+3),.ui-sortable tr:nth-child(8n+4){background:#fff !important}
.ui-sortable tr:nth-child(8n+5),.ui-sortable tr:nth-child(8n+6),.ui-sortable tr:nth-child(8n+7),.ui-sortable tr:nth-child(8n+8){background:#ebe9e9 !important}
.ui-sortable tr:nth-child(n+5){opacity:0.5}
...
<div id="table-0" class="tabela2 col-lg-12 col-md-12">
	<div class="panel panel-white">
		<div class="panel-heading">
			<form id="id-form-filtro" onsubmit="return adm.busca();">
				<div class="lrow tab">
					...
					<div class="cell w150"><select name="idc" class="form-control"></select></div>
		...
		<div class="panel-body">
			<h4>Selecione o box "Mostrar na Home" na página do produto que você quer que apareça nessa lista. Segue exemplo:</h4>
			<img src="assets/img/mostrar-home.jpg" style="border:2px solid #ebebeb;margin-bottom:10px;padding:7px 0 0 20px"/>
