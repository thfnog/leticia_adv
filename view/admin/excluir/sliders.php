		...
		<div class="panel-body">
			<div class="table-responsive project-stats">
				<div class="lrow tab bold count">
					...
					<div class="cell right"><span class="save-pos"></span></div>
				</div>
...
var adm = $.tab({
	c:{a:'slider',mt:'este Slider',ma:'Novo Slider',add:'admin/slider/',fn:function(){
	...
	th:[
		...
		{n:'Título',w:250,o:'t',tt:'n',l:1,a:'admin/slider/',c:'id',tb:0},
