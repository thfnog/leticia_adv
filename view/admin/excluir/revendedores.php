...
var adm = $.tab({
	c:{a:'revendedor',mt:'este Revendedor',ma:'Novo Revendedor',add:'admin/revendedor/',fn:function(){
	...
	debugBuscaXML:0,
	o:'dc desc',
	oi:['id','dc','da','s','t','d','i','it','q','email','tp'],
	th:[
		{t:2,n:'Imagem',w:104,o:'i',tt:'n',a:'upload/revendas/',c:'i',d:'default.jpg',l:2,dl:1},
		{n:'Tipo de Cadastro',w:290,o:'tp',tt:'_tp',l:1,a:'admin/revendedor/',c:'id',tb:0},
		{n:'Nome / Razão Social',w:250,o:'t',tt:'n',l:1,a:'admin/revendedor/',c:'id',tb:0},
		{n:'E-mail',w:250,o:'email',tt:'email'},
		{n:'Cadastrado em',w:130,o:'dc',tt:'_dc'},
		{t:1,n:'VER',w:80,o:'id',c:'id',tb:0,bt:[{tt:1,m:'cp',a:'admin/revendedor/',i:['isearch'],t:['Ver Revendedor']}]},
