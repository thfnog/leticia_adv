...
var adm = $.tab({
	c:{a:'blog',mt:'este Post',ma:'Novo Post',add:'admin/blog/',fn:function(){
	...
	th:[
		...
		{t:1,n:'Recortar Imagens',w:115,o:'it',bt:[{tt:1,m:'cp',a:'admin/crop-blogs/',i:['icrop','icropped'],t:['Recortar Imagens','Imagens Recortadas']}]},
		{t:1,n:'Adicionar Fotos',w:250,o:'t',bt:[{tt:1,m:'cp',a:'admin/blog-foto/',i:'ifolder',t:'Adicionar Fotos'}]},
