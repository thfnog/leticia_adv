...
?>
						...
						<div class="btArticleMedia ">
							...
							<div class="btMediaBox"><img src="upload/servicos/thumb/<?=$fotos->iti?>" alt="<?=$fotos->alt?$fotos->alt:$rs->h1?>"></div>
...
?>
		...
		<aside class="btSidebar">
			...
			<div class="btBox widget_bt_bb_recent_posts">
				...
				<h4><span>Outros Serviços</span></h4>
...
$so = $b->query("select s.*,f.itu,f.alt from servico s left join fotos f on s.id=f.idp and f.tipo='servico' where s.s and s.id!={$s->id} limit 8");
...
?>
								...
								<div class="btImageTextWidgetImage">
									...
									<a href="<?=$ro->t?>"><img src="upload/servicos/thumb/<?=$ro->itu?>" class="attachment-thumbnail size-thumbnail wp-post-image" alt="<?=$ro->alt?$ro->alt:$ro->h1?>"></a>
