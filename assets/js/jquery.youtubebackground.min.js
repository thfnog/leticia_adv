"function" != typeof Object.create && (Object.create = function (e) {
	...
	function (e, t, o) {
		...
		YTPlayer = {
			...
			init: function (n, i) {
				var l, r, d, s = this;
				return s.userOptions = i, s.$body = e("body"), s.$node = e(n), s.$window = e(t), s.defaults.events = {
					onReady: function (e) {
				...
				}, s.options = e.extend(!0, {}, s.defaults, s.userOptions), s.options.height = Math.ceil(s.options.width / s.options.ratio), s.ID = (new Date).getTime(), s.holderID = "YTPlayer-ID-" + s.ID, s.options.fitToBackground ? s.createBackgroundVideo() : s.createContainerVideo(), s.$window.on("resize.YTplayer" + s.ID, function () {
					s.resize(s)
				}), l = s.onYouTubeIframeAPIReady.bind(s), r = o.createElement("script"), d = o.getElementsByTagName("head")[0], "file://" == t.location.origin ? r.src = "http://www.youtube.com/iframe_api" : r.src = "//www.youtube.com/iframe_api", d.appendChild(r), d = null, r = null, a(l), s.resize(s), s
			},
